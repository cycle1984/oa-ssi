...
<body>
	<!-- 导入页面相关js -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jsp/news_myList.js"></script>
	<!-- grid表格 -->
	<table id="news_myList_grid"></table>
	<!-- 工具面板 -->
	<div id="news_myList_toolbar" style="border: 0px;display: none;">
		<table>
			<tr>
				<td>
					<form id="news_myList_toolbar_form" style="margin:0px;"><!--style="margin:0px;"可以处理加form表单后，tr间隙变大的问题  -->
