		...
		<table>
			...
			<tr>
				<td>
					<table>
						<tr>
							<td><a onclick="addFunRole();" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" title="权限组添加">添加</a></td>
							<td><a onclick="editFunRole();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-edit'" title="权限组修改">修改</a></td>
							<td><a onclick="deleteFunRole();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" title="权限组删除">删除</a></td>
							<td><a onclick="setFunMyResource();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'ext-icon-group_key'" title="设置权限">设置权限</a></td>
