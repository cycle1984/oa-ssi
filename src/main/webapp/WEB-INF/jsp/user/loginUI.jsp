		...
		*/
				...
				onLoad:function(){//在加载远程数据时触发,初始化机构和单位的下拉菜单
		    		...
		    		$("#register_myGroupCombobox").combobox({
		    		    ...
		    		    onSelect:function(){
		    		    	...
		    		    	$("#register_unitCombobox").combobox('reload','${pageContext.request.contextPath}/unit/getUnitsByMyGroupId.do?myGroup.id='+myGroupId);
		    		    }
		    		});
		...
		var registerFun = function() {
			if ($('#register_form').form('validate')) {
				...
				$.post('${pageContext.request.contextPath}/user/register.do', $('#register_form').serialize(), function(result) {
					if (result.success) {
