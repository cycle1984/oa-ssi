...
//				iconCls:'icon-ok',
//				handler : function() {
//					$('#document_saveUI_unitCombotree').textbox('setText',$('#unit_searchByUnit_unit').val());//设置combotree文本框内容
//					dialog.dialog('close');
//				}
//			} ]
//		});
...
//	    	var isLeaf = $('#document_saveUI_unitCombotree').combotree('tree').tree('isLeaf',node.target);
//	    	if(isLeaf){
//				
//			}else{
